      ...
      <Nav className="flex-column mb-auto gap-1">
        ...
        {userRole === 'manager' && (
          <>
            ...
            <Nav.Link as={NavLink} to="/nouveau-ticket-interne" className="text-white d-flex align-items-center rounded px-3 py-2 sidebar-nav-link border-0" onClick={handleClose}>
